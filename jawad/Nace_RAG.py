...
# Q1 and Q2: llm.lab connection and print available models
...
# Q3: create a text from a single nace code
#%%
...
# Ex3; Q1: create a new Qdrant collection
#%%
...
#Q2: embed your NACE descriptions
#%%
from dataclasses import dataclass, field
...
# Q4: Update once again your NaceDocument to create a new method to build a Qdrant PointStruct like dictionary 
#%%
from dataclasses import dataclass, field
from typing import Optional, List
...
# Q6: Upload your points into your Qdrant collection
#%%
...
# Exercise 1; Q1: embed an activity level
#%%
...
# intermediate step: prompt construction: 
#%%
SYSTEM_PROMPT = """\
...
# 2: Utility function: a full pipeline call: 
#%%
...
# Ex 2: Code all activities in the dataset
#%%
from tqdm import tqdm
import pandas as pd
...
# Ex 3: prepare evaluation columns
#%%
...
# Q3: End-to-end pipeline accuracy
#%%
...
# Q4: Summary dashboard and error decomposition
#%%
n_total          = len(results)
